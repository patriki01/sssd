...
repository and run the tests with:
    ...
    .. dropdown:: Display solution
        ...
        .. code-block:: python
            ...
            def test__07(client: Client, ldap: LDAP):
                ...
                client.sssd.start()
                assert client.authentication.su.password('tuser', 'Secret123')
    ...
    .. dropdown:: Display solution
        ...
        .. code-block:: python
            ...
            def test__08(client: Client, ldap: LDAP):
                ...
                client.sssd.start()
                assert client.authentication.ssh.password('tuser', 'Secret123')
    ...
    .. dropdown:: Display solution
        ...
        .. code-block:: python
            ...
            def test__09(client: Client, ldap: LDAP, method: str):
                ...
                client.sssd.start()
                assert client.authentication.parametrize(method).password('tuser', 'Secret123')
    ...
    .. dropdown:: Display solution
        ...
        .. code-block:: python
            ...
            def test__10(client: Client, ldap: LDAP):
                ...
                assert client.authentication.sudo.list('tuser', 'Secret123', expected=['(root) /bin/ls'])
                assert client.authentication.sudo.run('tuser', 'Secret123', command='/bin/ls /root')
    ...
    .. dropdown:: Display solution
        ...
        .. code-block:: python
            ...
            def test__11(client: Client, ldap: LDAP):
                ...
                assert client.authentication.sudo.list('tuser', expected=['(root) NOPASSWD: /bin/ls'])
                assert client.authentication.sudo.run('tuser', command='/bin/ls /root')
    ...
    .. dropdown:: Display solution
        ...
        .. code-block:: python
            ...
            def test__30(client: Client, provider: GenericProvider):
                ...
                assert client.authentication.sudo.list('tuser', expected=['(root) ALL'])
                assert client.authentication.sudo.run('tuser', command='/bin/ls /root')
